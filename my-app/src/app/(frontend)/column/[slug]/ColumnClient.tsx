                ...
                <RichText
                  ...
                  converters={({ defaultConverters }) => ({
                    ...
                    blocks: {
                      ...
                      flexibleColumns: ({ node }: { node: any }) => <FlexibleColumnsComponent fields={node.fields} />,
                      videoEmbed: ({ node }: { node: any }) => <VideoEmbedComponent fields={node.fields} />,
                      callout: ({ node }: { node: any }) => <CalloutComponent fields={node.fields} />,
                      quote: ({ node }: { node: any }) => <QuoteComponent fields={node.fields} />,
                    },
                  })}
                />
              )}
